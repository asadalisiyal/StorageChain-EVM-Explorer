    ...
    <div>
      <Grid container spacing={3} direction="column">
        ...
        >
          ...
          <Grid key="chainId" item style={{borderLeft: "1px solid #e7eaf3"}}>
          ...
          <Grid key="gasPrice" item style={{borderLeft: "1px solid #e7eaf3"}}>
          ...
          <Grid key="hRate" item style={{borderLeft: "1px solid #e7eaf3"}}>
          ...
          <Grid key="peers" item style={{borderLeft: "1px solid #e7eaf3"}}>
